      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>FarmHub </h1>
            <p>We connect people and farmers together.</p>
            <a href="#myproduct" class="btn">look Here<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h1 id="myproduct">OUR PRODUCTS</h1>

    <div class="row">


      <!-- Recently Listed New product -->
...
<span class="price">Price <?php echo htmlentities($row['productPrice']);?> <s>  Price <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
